...
import { Upload, File, Search, Clock } from 'lucide-react';
...
const DocumentProcessor = () => {
  ...
  const services = [
    {
      id: 'haystack',
      name: 'Haystack',
      description: 'Processamento completo de documentos com IA',
      capabilities: ['Extração de texto', 'Sumarização', 'NER', 'RAG']
    },
    {
      id: 'tika',
      name: 'Apache Tika',
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-2xl">Processador de Documentos</CardTitle>
        </CardHeader>
        <CardContent>
          {/* Upload Section */}
          <div className="mb-6">
